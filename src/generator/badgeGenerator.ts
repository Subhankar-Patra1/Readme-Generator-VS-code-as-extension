...
export interface Badge {
    label: string;
    markdown: string;
    category: 'language' | 'framework' | 'database' | 'tool' | 'cloud' | 'meta';
}
...
type BadgeStyle = 'flat-square' | 'for-the-badge' | 'flat' | 'plastic';
 ...
 */
function createBadge(key: string, style: BadgeStyle = 'flat-square'): Badge | null {
 ...
 */
function getCategoryForKey(key: string): Badge['category'] {
 ...
 */
export function generateLicenseBadge(projectInfo: ProjectInfo): Badge | null {
 ...
 */
export function generateVersionBadge(projectInfo: ProjectInfo): Badge | null {
 ...
 */
export function generatePRsWelcomeBadge(): Badge {
    return {
        label: 'PRs Welcome',
 ...
 */
export function getBadgesMarkdown(
    projectInfo: ProjectInfo,
    detection: DetectionResult,
    style: BadgeStyle = 'flat-square'
): string {
