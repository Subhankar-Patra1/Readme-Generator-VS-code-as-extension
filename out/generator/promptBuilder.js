...
exports.buildSectionRegeneratePrompt = buildSectionRegeneratePrompt;
 ...
 */
function buildSectionInstructions(enabledSections, template) {
 ...
 */
function buildUserPrompt(projectInfo, detection, projectType, options, badges) {
    const projectSummary = (0, workspaceScanner_1.getProjectSummary)(projectInfo);
 ...
 */
function buildPrompt(projectInfo, detection, projectType, options) {
    // Generate badges using auto-detection
    const badges = options.includeBadges
        ? (0, badgeGenerator_1.getBadgesMarkdown)(projectInfo, detection)
        : undefined;
    return {
 ...
 */
function buildSectionRegeneratePrompt(section, projectInfo, detection, projectType, currentContent, customInstructions) {
    const projectSummary = (0, workspaceScanner_1.getProjectSummary)(projectInfo);
 ...
 */
function buildRefinementPrompt(instruction, currentReadme) {
